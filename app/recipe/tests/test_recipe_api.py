...
def create_recipe(user, **params):
    ...
    # if any fields were given in params, it would take what params
    # has. if not it would stay as is from default
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrive_recipes(self):
        ...
        # highest ids means lates with '-id'
        recipes = Recipe.objects.all().order_by("-id")
        # with many=True means return the list and not the detail
    ...
    def test_delete_other_users_recipe_error(self):
        ...
        url = detail_url(recipe.id)
        # res.user is equal to the setUp user not the new_user
        res = self.client.delete(url)
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            "time_minutes": 60,
            "price": Decimal("4.50"),
            "ingredients": [{"name": "Cumin"}, {"name": "Fish Sauce"}],
        }
        res = self.client.post(RECIPES_URL, payload, format="json")
    ...
    def test_updated_recipe_assign_ingredient(self):
    ...
    def test_filter_by_tags(self):
        ...
        recipe1 = create_recipe(user=self.user, title="Thai Veggie Soup")
        recipe2 = create_recipe(user=self.user, title="Tomatoe Soup")
        tag1 = Tag.objects.create(user=self.user, name="Vegan")
        tag2 = Tag.objects.create(user=self.user, name="Exotic")
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title="Red Lintil Dahl")
